...
initEditor (editorConfig *E)
{
	...
	/* newFrame(createNewWin(LINES - 2, COLS/2, 0, 0, 1), (textEditorBuffer *) g_ptr_array_index(E->buffers, 0)); */
	/* newFrame(createNewWin(LINES/2 - 2, COLS/2, 0, COLS/2, 1), (textEditorBuffer *) g_ptr_array_index(E->buffers, 1)); */
	/* newFrame(createNewWin(LINES/2 - 2, COLS/2, LINES/2, COLS/2, 1), (textEditorBuffer *) g_ptr_array_index(E->buffers, 2)); */
